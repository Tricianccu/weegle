...
function click10() {
	...
	document.getElementsByName("searchNum")[0].style.color = '#ffffff';
}
function click20() {
...
<div class='note'>
<img src="images/wego.png" style = 'position:absolute;width:40px;height:40px;margin-top:520px' >
</div> 
<div class='note1'>
<img src="images/wego.png" style = 'position:absolute;width:40px;height:40px;margin-top:520px' >
</div> 
...
<div>
<input type='text' name='searchNum' value='10' style='color:#ffffff;border-style:none;background-color:#ffffff'>
</div>
<div>
...
<div>
<a href ='http://localhost:8080/Final_Project/TestProject'><img src="images/weegle.png" style='position:absolute;width:350px;height:150px;left:50%;top:50%;margin-top:-265px;
margin-left:-175px '></a>
</div>
</form>
</body>
